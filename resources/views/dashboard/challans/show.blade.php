            ...
            <header class="flex justify-between items-start mb-8">
                ...
                <div class="text-right">
                    ...
                    <div class="grid grid-cols-2 text-sm">
                        ...
                        <div class="border border-gray-400 p-1">{{ $challan->created_at->format('d/m/Y') }}</div>
            ...
            <section class="grid grid-cols-2 gap-8 mb-8 text-sm">
                <div>
                    ...
                    <div class="border border-gray-400 p-3 space-y-1">
                        <p><strong class="w-16 inline-block">Name</strong> : {{ $challan->quotation->user->name }}</p>
                ...
                <div>
                    ...
                    <div class="border border-gray-400 p-3 space-y-1">
                        <p><strong class="w-24 inline-block">Name</strong> :
                            {{ $challan->quotation->customer->customer_name }}</p>
                        <p><strong class="w-24 inline-block">Designation</strong> :
                            {{ $challan->quotation->customer->designation }}</p>
