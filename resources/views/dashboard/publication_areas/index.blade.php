<x-dashboard.layout.default title="Publication Areas">
    ...
    <x-ui.card class="mx-auto">
        <div class="grid grid-cols-8 p-2 mb-4">
            ...
            @can('publication list')
                <a href="{{ route('publication-areas.create') }}"
        ...
        <div class="relative overflow-x-auto sm:rounded-lg py-3 px-2">
            <table id="pub-area"
                ...
                <tbody>
                    @foreach ($publicationAreas as $item)
                        <tr
                            ...
                            @can('publication edit')
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('publication-areas.edit', $item->id) }}"
                            ...
                            @can('publication delete')
                                <td>
                                    <form action="{{ route('publication-areas.destroy', $item->id) }}" method="POST"
