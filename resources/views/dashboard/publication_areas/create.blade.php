<x-dashboard.layout.default title="Add New Area of Publications">
...
<x-ui.card heading="Add New Area of Publications">
    <form action="{{ route('publication-areas.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="grid grid-cols-5 gap-4 items-center">
                    ...
                    <div class="col-span-4">
                        <x-ui.form.input id="pa-name" name="name" label="Publication Area Name"
                            placeholder="Enter Publication Area Name" class="w-full p-2 text-lg" required />
                    </div>
