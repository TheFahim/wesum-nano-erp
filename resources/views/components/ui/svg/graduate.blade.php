<svg {{$attributes(["class" => "text-gray-800 dark:text-white"])}} class="text-gray-800 dark:text-white" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 64 64" style="enable-background:new 0 0 512 512" xml:space="preserve"
    class="">
    <g>
        <path
