<svg {{ $attributes(['class' => 'text-gray-800 dark:text-white']) }} xmlns="http://www.w3.org/2000/svg" version="1.1"
    xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512"
    xml:space="preserve" class="">
    <g>
        <path
            d="M6.009 6.5a4 4 0 1 1 4 4 4 4 0 0 1-4-4zM13.1 18.82a1.9 1.9 0 0 1-.51-1.98 1.922 1.922 0 0 1 1.58-1.33l1.25-.18s.2-.019.26-.14l.4-.8a.331.331 0 0 0 .04-.19.316.316 0 0 0-.08-.15A5.284 5.284 0 0 0 12 12.5H8c-4.06 0-5.5 2.97-5.5 5.52 0 2.28 1.21 3.48 3.5 3.48h7.59c.16 0 .262-.12.31-.38l.2-1.15a.278.278 0 0 0-.09-.27zm8.767-1.081a.435.435 0 0 0-.247-.745l-1.992-.283a.444.444 0 0 1-.335-.239l-.864-1.712a.481.481 0 0 0-.855 0l-.863 1.712a.445.445 0 0 1-.335.239l-1.992.283a.434.434 0 0 0-.247.745l1.44 1.374a.432.432 0 0 1 .129.388l-.329 1.879a.474.474 0 0 0 .691.493l1.727-.888a.451.451 0 0 1 .414 0l1.728.889a.474.474 0 0 0 .69-.493L20.3 19.5a.434.434 0 0 1 .128-.388z"
